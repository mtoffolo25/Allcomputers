import { cartManager, productManager, userManager } from "../services/factory.js";
...
const detailProduct = async (req, res) => {
    ...
    let detail = await productManager.getProductById(pid);

    res.render('detailProducts', detail)};

export { getProductController, authMiddleWareController, detailProduct }